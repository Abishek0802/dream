...
const SignUp = () => {
  ...
  return (
    ...
    <Box className='bg'sx={{width:'500px',height:'500px',marginTop:'120px',marginLeft:'70px'}}> 
     ...
     <Box className='outer' sx={{transition:'transform 200ms',transitionTimingFunction:'cubic-bezier(.25,-3,5,4)', boxShadow:9,borderRadius:2,backgroundColor:'rgb(147, 208, 208)',textAlign:'center',height:'450 px',width:'25%',marginLeft:'15%',marginTop:'10%',padding:'10px',"&:hover":{transform:'scale(1.1)'}}}>
      ...
      <Typography>Already a Member Click -<Link to='/Login' className='link'>Login</Link></Typography>
    </Box>
